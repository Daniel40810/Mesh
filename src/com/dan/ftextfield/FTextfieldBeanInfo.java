...
/**
 * BeanInfo fuer {@link FTextfield}. Zeichnet das Palette-Icon programmatisch
 * (kein externes Bild noetig): Glaskoerper im Weinrot&rarr;Tuerkis-Verlauf mit
 * hellblauem Rand, Glanzstreifen, schwebendem Label-Strich und Text-Caret &ndash;
 * im gleichen Stil wie {@code FComboBoxBeanInfo}.
 */
public class FTextfieldBeanInfo extends SimpleBeanInfo {
    ...
    public Image getIcon(int iconKind) {
        ...
        try {
            ...
            // Glaskoerper mit Weinrot->Tuerkis Verlauf (wie FComboBox-Icon).
            ...
            // Schwebendes Label (kurzer Strich oben links, ueber dem Feld).
            ...
            g2.drawLine(cx, cy - Math.max(2, size / 9), cx, cy + Math.max(2, size / 9));
        } finally {
            g2.dispose();
        }
        return img;
